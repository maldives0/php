...
<body>
    ...
    <form action="modify-ok.php" method="post" enctype="multipart/form-data">
        <article>
            <h2>수정하기</h2>
            <ul>
                <li><label>제목</label><input type="text" name="name" value="<?=$row['name']?>"></li>
                <li><label >첨부파일</label>
                    <?
                    ...
                    ?>
                    <input type="file" name="file" id="btn" style="display:none;">
<!--                   <a id="btn3">이미지선택</a>--><label for="btn">이미지선택</label>
                </li>
                <li><label>내용</label>
...
//            },500);
    ...
    <script type="text/javascript">
        ...
        //editor내용을 textarea에 복사 후 write-ok.php 이동
